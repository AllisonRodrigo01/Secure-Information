    ...
    <script>
        const modules = {
            1:{
                ...
                videoUrl: "videos/CONCEITOS BÁSICOS DE SEGURANÇA DA INFORMAÇÃO.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
            ...
            2: {
                ...
                videoUrl: "videos/Protecao de dados.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
                    <h2>Criptografia</h2>
            ...
            3: {
                ...
                videoUrl: "videos/ameacas.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
            ...
            4: {
                ...
                video: "Senhas Fortes",
                videoUrl: "videos/senha forte.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
            ...
            5: {
                ...
                videoUrl: "videos/Phishing.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
            ...
            6:{
                ...
                videoUrl: "videos/navegacao segura.mp4", // ← COLOQUE O NOME DO SEU ARQUIVO DE VÍDEO AQUI
                content: `
